...
public class AuthUtils {
	 ...
	 * @param login
	 * @param password
	 * @return null as 'false', same hash string as 'true' and new hash string if hash is to be
	 *         upgraded. */
	...
	public static final String hashPassword(final String login, final String password) {
		...
		final byte[] bytes = digest.digest((login + '-' + password).getBytes(StandardCharsets.UTF_8));
