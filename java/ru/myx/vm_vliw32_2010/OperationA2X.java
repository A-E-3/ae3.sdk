...
/** @author myx */
public interface OperationA2X extends VOFmtA2 {
	 ...
	 * @param constant
	 * @return */
	default InstructionIA instruction(final BaseObject constantArgumentA, final ModifierArgument defaultArgumentA, final ModifierArgument argumentB, final int constant) {

		return new IA2_AXXX_AB_C_NN_NXT(
				this,
				defaultArgumentA == null
	 ...
	 * @param state
	 * @return */
	default InstructionIA instruction(final BaseObject constantArgumentA,
		...
		if (constant == 0) {
			...
			if (store == ResultHandler.FC_PNN_RET) {
				return new IA2_AXXX_OB_0_NN_RET(this, constantArgumentA, argumentB);
			}
			if (store == ResultHandler.FB_BSN_NXT) {
				return new IA2_AXXX_OB_0_SN_NXT(this, constantArgumentA, argumentB);
			}

			return new IA2_AXXX_AB_0_XX_XXX(
					this,
					defaultArgumentA == null
						? new ModifierArgumentA30IMM(constantArgumentA)
						: defaultArgumentA,
		...
		return new IA2_AXXX_AB_C_XX_XXX(
				this,
				defaultArgumentA == null
					? new ModifierArgumentA30IMM(constantArgumentA)
					: defaultArgumentA,
	 ...
	 * @param constant
	 * @return */
	default InstructionIA instruction(final ModifierArgument argumentA, final BaseObject constantArgumentB, final ModifierArgument defaultArgumentB, final int constant) {

		return constant == 0
			? new IA2_AXXX_AO_0_NN_NXT(this, argumentA, constantArgumentB)
			: new IA2_AXXX_AO_C_NN_NXT(this, argumentA, constantArgumentB, constant);
	}
	...
	default InstructionIA instruction(final ModifierArgument argumentA,
		...
		if (constant == 0) {
			...
			if (store == ResultHandler.FC_PNN_RET) {
				return new IA2_AXXX_AB_0_NN_RET(
						this,
						argumentA,
						defaultArgumentB == null
							? new ModifierArgumentA30IMM(constantArgumentB)
							: defaultArgumentB);
			}
			if (store == ResultHandler.FB_BSN_NXT) {
				return new IA2_AXXX_AB_0_SN_NXT(
						this,
						argumentA,
						defaultArgumentB == null
							? new ModifierArgumentA30IMM(constantArgumentB)
	 ...
	 * @param store
	 * @return */
	default InstructionIA instruction(final ModifierArgument argumentA, final ModifierArgument argumentB, final int constant, final ResultHandler store) {

		if (store == ResultHandler.FA_BNN_NXT) {
			if (argumentB == AA0RB) {
				if (argumentA == AE21POP) {
					return new IA2_AXXX_PR_X_NN_NXT(this, constant);
				}
				return constant == 0
					? new IA2_AXXX_AR_0_NN_NXT(this, argumentA)
					: new IA2_AXXX_AR_C_NN_NXT(this, argumentA, constant);
			}
			{
			...
			return new IA2_AXXX_AB_C_NN_NXT(this, argumentA, argumentB, constant);
		}
		...
		if (constant == 0) {
			if (store == ResultHandler.FC_PNN_RET) {
				return new IA2_AXXX_AB_0_NN_RET(this, argumentA, argumentB);
			} else//
			if (store == ResultHandler.FB_BSN_NXT) {
				return new IA2_AXXX_AB_0_SN_NXT(this, argumentA, argumentB);
			}

			return new IA2_AXXX_AB_0_XX_XXX(this, argumentA, argumentB, store);
		}
		return new IA2_AXXX_AB_C_XX_XXX(this, argumentA, argumentB, constant, store);
	}
	...
	default InstructionEditable instructionCreate(final ModifierArgument argumentA, final ModifierArgument argumentB, final int constant, final ResultHandler store) {
		...
		return new InstructionIA2E(this, argumentA, argumentB, constant, store);
	}
