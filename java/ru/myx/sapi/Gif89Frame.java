...
abstract class Gif89Frame {
	...
	// ----------------------------------------------------------------------------
	void encode(final OutputStream os, final boolean epluribus, final int colorDepth, final int transparentIndex)
			throws IOException {
	...
	// ----------------------------------------------------------------------------
	private void writeGraphicControlExtension(final OutputStream os, final boolean epluribus, final int itransparent)
			throws IOException {
...
class GifPixelsEncoder {
	...
	// ----------------------------------------------------------------------------
	GifPixelsEncoder(final int width,
			final int height,
			final byte[] pixels,
