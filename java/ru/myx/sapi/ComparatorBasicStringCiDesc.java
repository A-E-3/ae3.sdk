...
final class ComparatorBasicStringCiDesc implements Comparator<ControlBasic<?>> {
	private final String	fieldName;
	
	ComparatorBasicStringCiDesc(final String fieldName) {
	...
	public final int compare(final ControlBasic<?> arg0, final ControlBasic<?> arg1) {
		...
		return s1.compareToIgnoreCase( s0 );
	}
}
