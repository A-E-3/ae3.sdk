...
final class Queue {
	...
	private static final Function<Object, Object> OVERHEAD1_TEST = new Function<>() {
	...
	private static final Function<Benchmark.Result, Object> OVERHEAD_TARGET = new Function<>() {
