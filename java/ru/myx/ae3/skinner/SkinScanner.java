...
public class SkinScanner extends BaseHostEmpty implements Runnable {
	...
	static {
		...
		SKIN_PRIVATE = new SkinScanner(skinPrivate, new TreeMap<>());
		SKIN_PROTECTED = new SkinScanner(skinProtected, new TreeMap<>());
		SKIN_PUBLIC = new SkinScanner(skinPublic, new TreeMap<>());
