 ...
 * @author myx
 * 
 *         Geometry has predefined set of layouts. Any GeometryRenderer must
 *         implement all of defined layouts here for its particular media type.
 * 
 */
public enum GeometryLayout {
	 ...
	 */
	ATTACHMENT {
		final String[]	contentPropertyNames	= new String[] { "attachment", "content" };
	 ...
	 */
	CONTAINER {
		final String[]	contentPropertyNames	= new String[] { "content" };
