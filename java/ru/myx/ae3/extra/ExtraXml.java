...
public final class ExtraXml extends BasicExtra {
	 ...
	 * @param attachment
	 */
	public ExtraXml(final Object issuer,
			final String recId,
			final long recDate,
					...
					if (storedString != null) {
						...
						try {
							...
							try {
								...
								/**
								 * ConcurrentModificationException or
								...
								try {
									...
									Report.exception( "EXTRA",
											"Exception while trying to reproduce new reference",
											this.name(),
											t );
								}
								if (external == this) {
						...
						if (stored == null) {
							throw new IllegalStateException( this.name()
									+ ": underlying local file is deleted and cannot be reproduced" );
						}
					}
