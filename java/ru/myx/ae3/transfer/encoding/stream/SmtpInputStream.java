 ...
 * makes sure that email new line character sequence - i.e.: the canonical form
 * "\r\n" - is returned as a platform specific new line character sequence.
 * Secondly, it checks for transparent dots - i.e.: if a dot at the beginning of
 * the line is directly followed by another dot only one of them are returned.
 * 
...
public class SmtpInputStream extends FilterInputStream {
	 ...
	 * or otherwise the number of bytes read.
	 */
	@Override
	 ...
	 * is ended or otherwise the number of bytes read.
	 */
	@Override
