 ...
 * headers. The "b" encoding is a base 64 encoding so for more details, please
 * refer to the Base64OutputStream documentation for more details.
 * 
...
public class B_InputStream extends Base64InputStream {
	 ...
	 * @param in
	 */
	public B_InputStream(final InputStream in) {
		super( in );
	}
}
