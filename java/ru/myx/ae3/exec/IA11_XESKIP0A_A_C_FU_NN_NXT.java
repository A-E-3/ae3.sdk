...
/** @author myx */
final class IA11_XESKIP0A_A_C_FU_NN_NXT extends InstructionIA1I {

	private final ModifierArgument modifierA;
	
	private final int constant;
	
	IA11_XESKIP0A_A_C_FU_NN_NXT(final ModifierArgument modifierA, final int constant) {
	...
	public final ExecStateCode execCall(final ExecProcess process) throws Exception {
		...
		if (this.modifierA.argumentRead(process).baseToBoolean() == BaseObject.FALSE) {
