 ...
 * 
 */
final class IA3X_AXXX_AOC_C_NN_NXT extends InstructionA3XI {
	...
	public final ExecStateCode execCall(final ExecProcess process) throws Exception {
		...
		return this.operation.execute(process, argumentA, this.argumentB, argumentC, this.constant, ResultHandler.FA_BNN_NXT);
	}
