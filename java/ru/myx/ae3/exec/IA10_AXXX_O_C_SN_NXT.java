 ...
 *
 */
class IA10_AXXX_O_C_SN_NXT extends InstructionA10I {
	...
	IA10_AXXX_O_C_SN_NXT(final OperationA10 operation, final BaseObject argumentA, final int constant) {
	...
	public final boolean equals(final Object o) {
		...
		if (o instanceof IA10_AXXX_O_C_SN_NXT) {
			final IA10_AXXX_O_C_SN_NXT x = (IA10_AXXX_O_C_SN_NXT) o;
	...
	public final int hashCode() {
		...
		return this.operation.hashCode() //
				^ this.constant ^ ResultHandler.FB_BSN_NXT.hashCode() ^ 0 ^ this.argumentA.hashCode();
	}
