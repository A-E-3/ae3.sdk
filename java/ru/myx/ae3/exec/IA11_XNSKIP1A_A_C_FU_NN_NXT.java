...
/** @author myx */
final class IA11_XNSKIP1A_A_C_FU_NN_NXT extends InstructionIA1I {

	private final ModifierArgument modifierA;
	
	private final int constant;
	
	IA11_XNSKIP1A_A_C_FU_NN_NXT(final ModifierArgument modifierA, final int constant) {
	...
	public final ExecStateCode execCall(final ExecProcess process) throws Exception {
		...
		if (this.modifierA.argumentRead(process).baseValue() != null) {
	...
	public int getOperandCount() {
		...
		return OperationsA11.XNSKIP1A_P.getStackInputCount(this.constant) + this.modifierA.argumentStackRead();
	}
	
	@Override
	public final OperationA11 getOperation() {

		return OperationsA11.XNSKIP1A_P;
	}
