 ...
 * 
 */
final class IA2X_AXXX_AR_C_NN_NXT extends IA2X_AAAA_XX_X_NN_NXT {
	...
	IA2X_AXXX_AR_C_NN_NXT(final OperationA2X operation, final ModifierArgument modifierA, final int constant) {
	...
	public final boolean equals(final Object o) {
		...
		if (o instanceof IA2X_AXXX_AR_C_NN_NXT) {
			final IA2X_AXXX_AR_C_NN_NXT x = (IA2X_AXXX_AR_C_NN_NXT) o;
