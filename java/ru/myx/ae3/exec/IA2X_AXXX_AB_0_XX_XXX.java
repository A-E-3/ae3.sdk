 ...
 * 
 */
final class IA2X_AXXX_AB_0_XX_XXX extends InstructionA2XI {
	...
	IA2X_AXXX_AB_0_XX_XXX(final OperationA2X operation, final ModifierArgument modifierFilterA, final ModifierArgument modifierFilterB, final ResultHandler store) {
	...
	public final boolean equals(final Object o) {
		...
		if (o instanceof IA2X_AXXX_AB_0_XX_XXX) {
			final IA2X_AXXX_AB_0_XX_XXX x = (IA2X_AXXX_AB_0_XX_XXX) o;
			return this.operation == x.operation && this.store == x.store && this.modifierB == x.modifierB && this.modifierA == x.modifierA;
		}
		return false;
	}
