...
public class Instructions {
	...
	*/
	 ...
	 */
	public static final//
	Instruction INSTR_TYPEOF_A_R_S = OperationsA3X.XACALLO
			.instructionCached(ModifierArguments.AB7FV, ModifierArgumentA30IMM.TYPEOF, ModifierArguments.AA0RB, 0, ResultHandler.FB_BSN_NXT);
	
	/**
	 *
	 */
	public static final//
	Instruction INSTR_TYPEOF_A_R_V = OperationsA3X.XACALLO
			.instructionCached(ModifierArguments.AB7FV, ModifierArgumentA30IMM.TYPEOF, ModifierArguments.AA0RB, 0, ResultHandler.FA_BNN_NXT);
	
	/**
	 *
	 */
	public static final//
	Instruction INSTR_TYPEOF_A_S_S = OperationsA3X.XACALLO
			.instructionCached(ModifierArguments.AB7FV, ModifierArgumentA30IMM.TYPEOF, ModifierArguments.AE21POP, 0, ResultHandler.FB_BSN_NXT);
	
	/**
	 *
	 */
	public static final//
	Instruction INSTR_TYPEOF_A_S_V = OperationsA3X.XACALLO
			.instructionCached(ModifierArguments.AB7FV, ModifierArgumentA30IMM.TYPEOF, ModifierArguments.AE21POP, 0, ResultHandler.FA_BNN_NXT);
