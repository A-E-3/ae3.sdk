 ...
 */
/** @author myx */
public final class ExecAlwaysInstance extends BaseFunctionAbstract implements ExecCallableBoth.ExecStoreX {
	 ...
	 * @param code
	 * @param parentContext */
	public ExecAlwaysInstance(final ControlType<?, ?> result, final ControlFieldset<?> arguments, final ProgramPart code, final ExecProcess parentContext) {
		this.result = result;
