 ...
 * 
 */
final class IA11_XESKIP0A_A_C_NN_NXT extends InstructionA11I {
	...
	IA11_XESKIP0A_A_C_NN_NXT(final ModifierArgument modifierA, final int constant) {
	...
	public final boolean equals(final Object o) {
		...
		if (o instanceof IA11_XESKIP0A_A_C_NN_NXT) {
			final IA11_XESKIP0A_A_C_NN_NXT x = (IA11_XESKIP0A_A_C_NN_NXT) o;
	...
	public final ExecStateCode execCall(final ExecProcess process) throws Exception {
		...
		if ((process.ra0RB = this.modifierA.argumentRead(process)).baseToBoolean() == FALSE) {
	...
	public int getOperandCount() {
		...
		return OperationsA11.XESKIP0A_P.getStackInputCount(this.constant) + this.modifierA.argumentStackRead();
	}
	...
	public final OperationA11 getOperation() {
		...
		return OperationsA11.XESKIP0A_P;
	}
	...
	public final int hashCode() {
		...
		return OperationsA11.XESKIP0A_P.hashCode() //
