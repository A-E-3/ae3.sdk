...
/** Class for ExecNonMaskedException exceptions explicitly thrown from the script.
 *
 *
 * @author myx */
@ReflectionManual
public class ExecThrown extends ExecNonMaskedException implements Value<Object> {
	...
	@Override
	/** No reflection for this method of this class - should be transparent for thrown object */
	// @ReflectionExplicit
