 ...
 * 
 */
public final class CompareCharacterToObject implements Comparator<Object> {
	
	/**
	 * 
	 */
	public static final CompareCharacterToObject	INSTANCE	= new CompareCharacterToObject();
	
	private CompareCharacterToObject() {
		//
	}
