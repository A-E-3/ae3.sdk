 ...
 * 
 */
public final class CompareLongToObject implements Comparator<Object> {
	
	/**
	 * 
	 */
	public static final CompareLongToObject	INSTANCE	= new CompareLongToObject();
	
	private CompareLongToObject() {
		//
	}
