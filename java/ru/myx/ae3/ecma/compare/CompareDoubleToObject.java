 ...
 * 
 */
public final class CompareDoubleToObject implements Comparator<Object> {
	
	/**
	 * 
	 */
	public static final CompareDoubleToObject	INSTANCE	= new CompareDoubleToObject();
	
	private CompareDoubleToObject() {
		//
	}
