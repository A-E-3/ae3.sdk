...
final class TKO_BINSTANCEOF_A_S_S extends TokenOperator {
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		 ...
		 * </code>
		 */
		assembly.addInstruction(OperationsA2X.XBINSTOF.instruction(argumentA, argumentB, 0, store));
	}
	
	@Override
	public final String toCode() {
		
		return "BINSTANCEOF\t1\tS  ->S;";
	}
