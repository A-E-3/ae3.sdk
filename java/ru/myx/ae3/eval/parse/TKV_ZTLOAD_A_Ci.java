...
public final class TKV_ZTLOAD_A_Ci extends TokenValue implements ModifierArgument {
	...
	@Override
	public InstructionEditable toBooleanConditionalSkip(final ProgramAssembly assembly, final int start, final boolean compare, final boolean statement, final ResultHandler store)
			throws Evaluate.CompilationException {
