...
class TKO_POSTDEC_N_A_L_S extends TokenOperator {
	public static final TokenOperator	INSTANCE	= new TKO_POSTDEC_N_A_L_S();
	
	private TKO_POSTDEC_N_A_L_S() {
		//
	}
	...
	public TokenInstruction toStackValue(
		...
		return name != null
				...
				: new TKV_ACCESSPOSTDEC( argumentA, 2 );
	}
}
