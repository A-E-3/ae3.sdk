...
import ru.myx.ae3.exec.OperationA2X;
...
final class TKV_MADDS_BA_VV_S extends TokenValue {
	 ...
	 * @param detachable
	 */
	public TKV_MADDS_BA_VV_S(final TokenInstruction argumentA, final TokenInstruction argumentB, final boolean detachable) {
	 ...
	 * @param visibility
	 */
	public TKV_MADDS_BA_VV_S(final TokenInstruction argumentA, final TokenInstruction argumentB, final int visibility) {
		assert argumentA.isStackValue();
		assert argumentB.isStackValue();
		this.argumentA = argumentA;
		this.argumentB = argumentB;
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		assembly.addInstruction(((OperationA2X) (this.visibility == 2
			? OperationsS2X.VMADDS_N
			: this.visibility == 1
				? OperationsS2X.VMADDS_D
				: OperationsS2X.VMADDS_T))
	...
	public final String toCode() {
		...
		return (this.visibility == 2
			...
			: this.visibility == 1
				? OperationsS2X.VMADDS_D
				: OperationsS2X.VMADDS_T) + "(S)\t2\tVV ->S\t[" + this.argumentA + " " + this.argumentB + "];";
	}
