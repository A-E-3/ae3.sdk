...
final class TKO_ZCVTS_D_A_S_S extends TokenOperator {
	
	public static final TokenOperator INSTANCE = new TKO_ZCVTS_D_A_S_S();

	private TKO_ZCVTS_D_A_S_S() {
		//
	}
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		if (store == ResultHandler.FA_BNN_NXT) {
			assembly.addInstruction(OperationsS10.VCVTS_D.instruction(argumentA, 0, ResultHandler.FA_BNN_NXT));
			return;
		}

		assembly.addInstruction(OperationsS10.VCVTS_D.instruction(argumentA, 0, store));
	}

	@Override
	public final String toCode() {
		
		return OperationsS10.VCVTS_D + "\t1\tS  ->S;";
	}
	...
	public TokenInstruction toStackValue(final ProgramAssembly assembly, final TokenInstruction argumentA, final boolean sideEffectsOnly) {
		...
		return new TKV_ZCVTS(argumentA, 1);
	}
}
