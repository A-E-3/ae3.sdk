...
final class TKO_MNOT_T_A_S_S extends TokenOperator {
	
	public static final TokenOperator INSTANCE = new TKO_MNOT_T_A_S_S();

	private TKO_MNOT_T_A_S_S() {
		//
	}
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		assembly.addInstruction(OperationsA2X.XMBXOR_T.instruction(argumentA, ModifierArgumentA30IMM.MONE, 0, store));
	}
	...
	public final TokenInstruction toExecDetachableResult() {
		...
		return TKO_MNOT_D_A_S_S.INSTANCE;
	}

	@Override
	public final TokenInstruction toExecNativeResult() {

		return TKO_MNOT_N_A_S_S.INSTANCE;
	}
}
