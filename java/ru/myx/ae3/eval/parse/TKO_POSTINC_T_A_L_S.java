...
class TKO_POSTINC_T_A_L_S extends TokenOperator {
	public static final TokenOperator	INSTANCE	= new TKO_POSTINC_T_A_L_S();
	
	private TKO_POSTINC_T_A_L_S() {
		//
	}
	...
	public TokenInstruction toExecDetachableResult() {
		return TKO_POSTINC_D_A_L_S.INSTANCE;
	}
	...
	public TokenInstruction toStackValue(
		...
		return name != null
				...
				: new TKV_ACCESSPOSTINC( argumentA, 0 );
	}
}
