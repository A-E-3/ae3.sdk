...
final class TKV_ZMAND extends TokenValue {
	...
	TKV_ZMAND(final TokenInstruction argumentA, final int argumentB, final boolean detachable) {
	...
	TKV_ZMAND(final TokenInstruction argumentA, final int argumentB, final int visibility) {
		// assert argumentA.toConstantModifier() == null : "Reduce then!";
		this.argumentA = argumentA;
		this.argumentB = argumentB;
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		assembly.addInstruction((this.visibility == 2
			? OperationsS10.VMBAND_N
			: this.visibility == 1
				? OperationsS10.VMBAND_D
				: OperationsA10.ZMAND_T)//
	...
	public final String toCode() {
		...
		return (this.visibility == 2
			...
			: this.visibility == 1
				? OperationsS10.VMBAND_D
				: OperationsA10.ZMAND_T) + "\t1\tV [" + this.argumentA + ", " + this.argumentB + "]  ->S;";
	}
