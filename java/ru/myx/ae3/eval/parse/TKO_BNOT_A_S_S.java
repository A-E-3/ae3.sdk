...
final class TKO_BNOT_A_S_S extends TokenOperator {
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		if (constantArgument != null) {
			...
			assembly.addInstruction(OperationsA10.XFLOAD_P.instruction(//
					constantArgument.baseToBoolean(),
					(constantArgument.baseToJavaBoolean()
						? ParseConstants.TKV_BOOLEAN_FALSE
						: ParseConstants.TKV_BOOLEAN_TRUE).toConstantModifier(),
					0,
					store));
			return;
		}
		...
		assembly.addInstruction(OperationsA10.XBNOT_N.instruction(argumentA, 0, store));
	}
