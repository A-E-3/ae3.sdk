...
final class TKV_ZMSHL extends TokenValue {
	...
	TKV_ZMSHL(final TokenInstruction argumentA, final int argumentB, final boolean detachable) {
	...
	TKV_ZMSHL(final TokenInstruction argumentA, final int argumentB, final int visibility) {
		// assert argumentA.toConstantModifier() == null : "Reduce then!";
		this.argumentA = argumentA;
		this.argumentB = argumentB;
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		assembly.addInstruction((this.visibility == 2
			? OperationsS10.VMBSHL_N
			: this.visibility == 1
				? OperationsS10.VMBSHL_D
				: OperationsA10.ZMSHL_T)//
	...
	public final String toCode() {
		...
		return (this.visibility == 2
			...
			: this.visibility == 1
				? OperationsS10.VMBSHL_D
				: OperationsA10.ZMSHL_T) + "\t1\tV [" + this.argumentA + ", " + this.argumentB + "]  ->S;";
	}
