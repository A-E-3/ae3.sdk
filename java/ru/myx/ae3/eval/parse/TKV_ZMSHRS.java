...
final class TKV_ZMSHRS extends TokenValue {
	...
	TKV_ZMSHRS(final TokenInstruction argumentA, final int argumentB, final int visibility) {
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		assembly.addInstruction((this.visibility == 2
			? OperationsS10.VMBSHRS_N
			: this.visibility == 1
				? OperationsS10.VMBSHRS_D
				: OperationsA10.ZMSHRS_T)//
	...
	public final String toCode() {
		...
		return (this.visibility == 2
			...
			: this.visibility == 1
				? OperationsS10.VMBSHRS_D
				: OperationsA10.ZMSHRS_T) + "\t1\tV [" + this.argumentA + ", " + this.argumentB + "]  ->S;";
	}
