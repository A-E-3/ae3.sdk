...
final class TKO_MNOT_D_A_S_S extends TokenOperator {
	...
	public static final TokenOperator INSTANCE = new TKO_MNOT_D_A_S_S();

	private TKO_MNOT_D_A_S_S() {
		//
	}
	...
	public void toAssembly(final ProgramAssembly assembly, final ModifierArgument argumentA, final ModifierArgument argumentB, final ResultHandlerBasic store) {
		...
		assembly.addInstruction(OperationsS2X.VMBXOR_D.instruction(argumentA, ModifierArgumentA30IMM.MONE, 0, store));
	}
