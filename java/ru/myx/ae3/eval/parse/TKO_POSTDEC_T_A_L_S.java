...
class TKO_POSTDEC_T_A_L_S extends TokenOperator {
	public static final TokenOperator	INSTANCE	= new TKO_POSTDEC_T_A_L_S();
	
	private TKO_POSTDEC_T_A_L_S() {
		//
	}
	...
	public TokenInstruction toExecDetachableResult() {
		return TKO_POSTDEC_D_A_L_S.INSTANCE;
	}
	...
	public TokenInstruction toStackValue(
		...
		return name != null
				...
				: new TKV_ACCESSPOSTDEC( argumentA, 0 );
	}
}
