 ...
 *
 */
public final class ValueSourceLongEx extends ValueSource<BasePrimitiveNumber> {
	 ...
	 * @param attribute
	 */
	public ValueSourceLongEx(final String attribute) {
	...
	public final BasePrimitiveNumber getObject(final Object argument) {
		...
		try {
			return Act.run(ctx, function -> function.execCallPreparedInilne(ctx).baseToInteger(), this.function);
