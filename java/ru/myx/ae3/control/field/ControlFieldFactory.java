...
public final class ControlFieldFactory {
	...
	public static final ControlField createField(final String type, final BaseObject attributes) {
		...
		Object result = Produce.object(
				...
				null);
		if (result == null) {
			Report.warning("AE1/FIELD_MANAGER", "Cannot find appropriate field class, '" + type + "' specified, replacing with 'string'");
	...
	public static final ControlField createFieldFloating(final String id, final Object title, final double defaultValue) {
		...
		return ControlFieldFactory.createFieldFloating(id, title, defaultValue, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
	}
	 ...
	 * @param field
	 * @param fields */
	public static final void registerFieldClass(final String factoryIdentity, final ControlField field, final Map<String, ControlField> fields) {
