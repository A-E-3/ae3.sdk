...
public final class Message {
	 ...
	 * @return string
	 */
	public static final String cleanAttributeValue(
	...
	/**
	 * 
	 * Returns charset for given message attributes (based on 'Content-Type:
	 * xxx/xxx; charset=' like stuff) and defaults to UTF-8.
	 * 
	 * @param attributes
	 * @return
	 */
	public static Charset getCharset(final BaseObject attributes) {
		...
		}
		{
			...
			if (encoding != null) {
				return Engine.ENCODING_UTF8.equalsIgnoreCase( encoding )
						? Engine.CHARSET_UTF8
						: Charset.forName( encoding );
			}
		}
		{
			final String encoding = Base.getString( attributes, "Charset", null );
			if (encoding != null) {
				return Engine.ENCODING_UTF8.equalsIgnoreCase( encoding )
						? Engine.CHARSET_UTF8
						: Charset.forName( encoding );
	 ...
	 * @return string
	 */
	public static final String subAttributeValue(
			final BaseMap attributes,
			final String attributeName,
	...
	public static final String subAttributeValue(
		...
		return Convert.MapEntry.toString( Flow.mimeAttribute( "", "", val ).getAttributes(),
				subattributeName,
				defaultValue );
	}
