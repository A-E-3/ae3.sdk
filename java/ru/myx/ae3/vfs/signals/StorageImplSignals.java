...
/** @author myx */
public class StorageImplSignals //
		implements
			ArsStorage<RecordSignals, ReferenceSignals, ArraySignals> //
{
	...
	@Override
	public RecordSignals createBinaryTemplate(final TransferCopier copier) {
	...
	@Override
	public RecordSignals createKeyForString(final String key) {

		return new RecordSignals(key, this.signals.get(key));
	}

	@Override
	public RecordSignals createPrimitiveTemplate(final Guid guid) {
	...
	@Override
	public ReferenceSignals createReferenceTemplate(final RecordSignals key, final TreeLinkType mode, final ReferenceSignals target) {

		return new ReferenceSignals(this.root, key, target.getTarget());
	}

	@Override
	public RecordSignals createTextTemplate(final CharSequence text) {
	...
	@Override
	public ReferenceSignals doLinkDelete(final ReferenceSignals template, final RecordSignals object, final RecordSignals key, final TreeLinkType mode) {
	...
	@Override
	public ReferenceSignals doLinkMoveRename(final ReferenceSignals template,
	...
	@Override
	public ReferenceSignals doLinkRename(final ReferenceSignals template,
			final RecordSignals object,
			final RecordSignals key,
			final RecordSignals newKey,
			final TreeLinkType mode,
	...
	@Override
	public ReferenceSignals doLinkSet(final ReferenceSignals template,
			final RecordSignals object,
			final RecordSignals key,
			final TreeLinkType mode,
			final long modified,
	...
	void executeSignal(final String key) {
	...
	@Override
	public Value<TransferCopier> getBinary(final RecordSignals object) {
	...
	@Override
	public ReferenceSignals getLink(final RecordSignals object, final RecordSignals key, final TreeLinkType mode) {
	...
	@Override
	public ArraySignals getLinks(final RecordSignals object, final TreeReadType mode) {
	...
	@Override
	public Value<ArraySignals> getLinksRange(final RecordSignals object,
		...
		}
		{
			...
			final String stop = keyStop == null
				? null
				: keyStop.key;
			final VfsDefaultLimitSortMatcher<String, Map.Entry<String, Function<Void, Object>>> matcher = new VfsDefaultLimitSortMatcher<>(start, stop, limit, backwards);
			for (final Map.Entry<String, Function<Void, Object>> entry : this.signals.entrySet()) {
				final String key = entry.getKey();
	...
	@Override
	public Value<? extends CharSequence> getText(final RecordSignals object) {
