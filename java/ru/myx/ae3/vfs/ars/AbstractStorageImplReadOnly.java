 ...
 * @param <A>
 */
public abstract class AbstractStorageImplReadOnly<O extends ArsRecord, R extends ArsReference<O>, A extends ArsArray<R>>
		extends AbstractStorageImpl<O, R, A> {
	...
	@Override
	public final Value<R> doLinkMoveRename(
			final R template,
			final O object,
			final O key,
			final O newObject,
	...
	@Override
	public final Value<R> doLinkRename(
			final R template,
			final O object,
			final O key,
			final O newKey,
	...
	@Override
	public final Value<R> doLinkSet(
			final R template,
			final O object,
			final O key,
			final TreeLinkType mode,
