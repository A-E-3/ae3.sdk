 ...
 * 
 */
public final class CompareIntegerToObject implements Comparator<Object> {
	
	/**
	 * 
	 */
	public static final CompareIntegerToObject	INSTANCE	= new CompareIntegerToObject();
	
	private CompareIntegerToObject() {
		//
	}
