 ...
 * 
 */
public final class CompareObjectToString implements Comparator<Object> {
	
	/**
	 * 
	 */
	public static final CompareObjectToString	INSTANCE	= new CompareObjectToString();
	
	private CompareObjectToString() {
		//
	}
