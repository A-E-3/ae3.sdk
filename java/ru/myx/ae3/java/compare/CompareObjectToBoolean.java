 ...
 * 
 */
public final class CompareObjectToBoolean implements Comparator<Object> {
	
	/**
	 * 
	 */
	public static final CompareObjectToBoolean	INSTANCE	= new CompareObjectToBoolean();
	
	private CompareObjectToBoolean() {
		//
	}
