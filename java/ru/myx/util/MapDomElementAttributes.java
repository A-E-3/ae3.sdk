	...
	final class EntrySet extends AbstractSet<Map.Entry<String, Object>> {
		final class EntrySetIterator implements Iterator<Map.Entry<String, Object>> {
			...
			public Map.Entry<String, Object> next() {
				return new EntrySimple<String, Object>( MapDomElementAttributes.this.map.item( this.counter )
						.getNodeName(), MapDomElementAttributes.this.map.item( this.counter-- ).getNodeValue() );
			}
